...
| deezer | <center>Отстутствует возможности прослушивания музыки в экранном режиме</center> | <center>—</center> |
| Musicram | <center>Отсутствует прослушивание при выключенном экране</center> | <center>—</center> |
...
| deezer | <center>Имеется сложная структура, безграмотный подход к размещению точек доступа к пунктам меню</center> | <center>—</center> |
| Musicram | <center>Отстутствует необходимая для поиска композиций информация</center>  | <center>—</center> |
...
| deezer | <center>Присутствует изобилие ярких цветов, режущих глаза</center> | <center>—</center> |
| Musicram | <center>Присутствуют изображения низкого качества, мелкий шрифт</center> | <center>—</center> |
