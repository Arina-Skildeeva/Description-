...
|---|---|---|
|       |<center> Возможности прослушивания </center> | Осуществлять прослушивания при выходе из приложения и с заблокированным экраном смартфона |
| deezer | Отстутствует возможности прослушивания музыки в экранном режиме | — |
| Musicram | Отсутствует прослушивание при выключенном экране | — |
|       | Устройство структуры | Осуществить доступность для понимания структуры, все необходимые сведения размещаются на главной странице |
| deezer | Имеется сложная структура, безграмотный подход к размещению точек доступа к пунктам меню |
| Musicram | Отстутствует необходимая для поиска композиций информация  |
