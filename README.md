...
Как пример, рассмотрим уже два существующих сайта потенциальных конкурентов - "deezer" и "Musicram", и сравним их с данной информационной системой по нескольким критериям, обозначив её как "Music Library".
